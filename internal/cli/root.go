...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "hyperliquid",
		Short: "Manage hyperliquid resources via the hyperliquid API",
		Long: `Manage hyperliquid resources via the hyperliquid API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'hyperliquid doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("hyperliquid {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'hyperliquid profile list')")
	...
	rootCmd.AddCommand(newBuilderCmd(flags))
