...
Data must be synced first with the sync command.`,
  ...
  hyperliquid analytics --type messages

  # Group by a field
  hyperliquid analytics --type messages --group-by author_id

  # Top 10 most frequent values
  hyperliquid analytics --type messages --group-by channel_id --limit 10 --json`,
